...
오른쪽 위 **한국어 / Русский** 버튼으로 언어를 전환할 수 있습니다. [러시아어로 바로 열기](https://money-clover.web.app/?lang=ru). 로그인과 작성 중인 입력은 유지되며 이름·기록·원화 금액은 바뀌지 않습니다. 쉬운 러시아어 번역의 난이도 2회·정확성 2회 검토 기록은 [번역 안내](docs/LOCALIZATION.md)에 있습니다.
